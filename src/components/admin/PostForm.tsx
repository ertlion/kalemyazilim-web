...
export default function PostForm({ initialData, isNew }: PostFormProps) {
  ...
  const current = activeTab === "tr" ? tr : en;

  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/admin/posts" className="p-2 text-gray-400 hover:text-gray-600 transition">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-4">
            <h3 className="font-semibold text-[#34373f]">Yayın Ayarları</h3>
